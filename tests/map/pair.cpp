...
void    pair_default()
{
    ...
    TYPECONT::pair<double, double>   pair;
...
void    pair_equal()
{
    ...
    TYPECONT::pair<double, double>   pair(0.005000, 0.005000);
    TYPECONT::pair<double, double>   pair_2(0.005000, 0.005000);
    TYPECONT::pair<double, double>   pair_3(0.005000, 0.000001);
...
void    pair_left()
{
    ...
    TYPECONT::pair<double, double>   pair(0.006000, 0.005000);
    TYPECONT::pair<double, double>   pair_2(0.005000, 0.006000);
    TYPECONT::pair<double, double>   pair_3(0.005000, 0.000001);
    TYPECONT::pair<double, double>   pair_4(0.000001, 0.005000);
...
void    pair_copy()
{
    ...
    TYPECONT::pair<double, double>   pair(1.006000, 2.005000);
    TYPECONT::pair<double, double>   pair_2 = pair;
    pair_2 = TYPECONT::make_pair(3, 3);
