...
void    pair_equal()
{
    ...
    std::pair<double, double>   pair_2(0.005000, 0.005000);
    std::pair<double, double>   pair_3(0.005000, 0.000001);
...
void    pair_left()
{
    ...
    std::pair<double, double>   pair_2(0.005000, 0.006000);
    std::pair<double, double>   pair_3(0.005000, 0.000001);
    std::pair<double, double>   pair_4(0.000001, 0.005000);
...
void    pair_copy()
{
    ...
    std::pair<double, double>   pair_2 = pair;
    pair_2 = std::make_pair(3, 3);
