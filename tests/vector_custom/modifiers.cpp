...
void    clear_custom()
{
    std::cout << "Clear CUSTOM, no values to be displayed below." << std::endl;
...
{
    std::cout << "Insert 100k CUSTOM" << std::endl;
...
{
    std::cout << "Insert reserve 100k CUSTOM" << std::endl;
    ft::vector<double> vec;
...
void    iterator_insert_custom()
{
    ...
    std::cout << "big pos first last insert CUSTOM" << std::endl;
    ft::vector<int>    vec2;
